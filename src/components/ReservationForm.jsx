...
function ReservationForm() {
	...
	const handleSubmit = async (e) => {
		...
		const reservationData = {
			...
			...vehicle,
			precio:
				parseFloat(vehicle.precio.replace(/\./g, "").replace(",", ".")) || 0, // Convertir a número
			sena: parseFloat(vehicle.sena.replace(/\./g, "").replace(",", ".")) || 0, // Convertir a número
			monto_final_abonar:
				parseFloat(
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					<div className="space-y-2">
						...
						<Input
							...
							type="date"
							value={vehicle.fecha_instalacion}
							onChange={handleVehicleChange}
							required
							className="rounded-full"
						/>
